...
public class CommandResponseSerializer extends JsonSerializer<CommandResponse> {
	...
	public void serializeAction(Action action, JsonGenerator jgen, String host, String deviceId, String cmdId,
			boolean isGet) throws IOException, JsonProcessingException {
		jgen.writeStringField("url", urlProtocol + host + urlDevicePath + deviceId + urlCmdPath + cmdId);
