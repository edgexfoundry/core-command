...
public class CommandResponseSerializerTest {
	...
	private static final String RESULT_JSON2 = "{\"name\":\"TEST_DEVICE.NAME\",\"id\":null,\"description\":null,\"labels\":null,\"adminState\":\"unlocked\",\"operatingState\":\"enabled\",\"lastConnected\":1000000,\"lastReported\":1000000,\"location\":null,\"commands\":null}";
	...
	public void testSerialize() throws IOException {
		...
		jgen.flush();
		jgen.close();
		assertEquals("Serialized response does not match expected", RESULT_JSON1, stringJson.toString());
	}
	...
	public void testProblematicNullFieldSerialization() throws IOException {
		...
		assertEquals("Serialized response does not match expected", RESULT_JSON2, stringJson.toString());
